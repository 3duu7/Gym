    ...
    <?php if (date('l') === 'Tuesday'): ?>
        ...
        <div class="body-content">
            ...
            <h5>Pecho 
              ...
              <?php if ($fourthTuesday == $today): ?>(3x4|1/2) <?php endif ?> 
            </h5>      
            ...
            <h5>Biceps
              ...
              <?php if ($fourthTuesday == $today): ?>(4x3|1/2) <?php endif ?> 
            </h5>
        ...
        <?php if ($thirdTuesday == $today || $fourthTuesday == $today): ?> 
          ...
          <div class="body-content">
            ...
            <h5>Pecho
              ...
              <?php if ($fourthTuesday == $today): ?>(3x4|2/2) <?php endif ?>
            </h5>
              <img src="../upload/pecho.gif" width="200" height="150">
              <img src="../upload/pecho2.gif" width="200" height="150">
              <img src="../upload/pecho3.gif" width="200" height="150">
            ...
            <h5>Biceps
              ...
              <?php if ($fourthTuesday == $today): ?>(4x3|2/2) <?php endif ?> 
            </h5>
              <img src="../upload/biceps.gif" width="200" height="150">
              <img src="../upload/biceps2.gif" width="200" height="150">
              <img src="../upload/biceps3.gif" width="200" height="150">
       ...
       <table style="position: absolute;left: 1100px;top:150px;">
          ...
          <tr>
            <th>Pecho</th>     
              ...
              <td class="alert" <?php if ($fourthMonday == $today || $fourthTuesday == $today || $fourthWednesday == $today || $fourthThursday == $today || $fourthFriday == $today || $fourthSaturday == $today || $fourthSunday == $today): ?> style=color:red <?php endif ?> >24</td>
          </tr>
